...
import static no.entur.nisaba.Constants.BLOBSTORE_MAKE_BLOB_PUBLIC;
import static no.entur.nisaba.Constants.FILE_HANDLE;
import static no.entur.nisaba.Constants.FILE_PREFIX;
...
public class BlobStoreRoute extends BaseRouteBuilder {
    ...
    @Autowired
    private MardukBlobStoreService mardukBlobStoreService;
    ...
    public void configure() {
        ...
        from("direct:copyBlobInBucket")
                ...
                .to(logDebugShowAll())
                .log(LoggingLevel.INFO, correlation() + "Copied file ${header." + FILE_HANDLE + "} to file ${header." + TARGET_FILE_HANDLE + "} in blob store in Nisaba bucket.")
        ...
        from("direct:copyBlobToAnotherBucket")
                ...
                .to(logDebugShowAll())
                .log(LoggingLevel.INFO, correlation() + "Copied file ${header." + FILE_HANDLE + "} to file ${header." + TARGET_FILE_HANDLE + "} in blob store from Nisaba bucket to another bucket (${header." + TARGET_CONTAINER + "}).")
