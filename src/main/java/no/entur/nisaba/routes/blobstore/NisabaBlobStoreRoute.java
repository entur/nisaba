...
public class NisabaBlobStoreRoute extends BaseRouteBuilder {
    ...
    public void configure() {
        ...
        from("direct:uploadNisabaBlob")
                ...
                .setBody(simple(""))
                .to(logDebugShowAll())
                .log(LoggingLevel.DEBUG, correlation() + "Stored file ${header." + FILE_HANDLE + "} in Nisaba bucket.")
        ...
        from("direct:getNisabaBlob")
                ...
                .to(logDebugShowAll())
                .log(LoggingLevel.DEBUG, correlation() + "Returning from fetching file ${header." + FILE_HANDLE + "} from Nisaba bucket.")
